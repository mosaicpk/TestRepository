 ...
 * 1) enable-auto-scroll for autoScroll to enable
 * 2) slide-timer for controlling the slider speed default is 3000
 * 3) slides-data is the data and data should be in this format {image:'',heading:'',description:''}
 * 4) show-full is for 100% width other wise use customWidth 
 * 5) custom-width is use for controlling the width of the slider manually
 * 
 */
...
const DEFAULT_SLIDER_TIMER = 4000 // 4 seconds
