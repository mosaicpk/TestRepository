...
import getAccountName from '@salesforce/apex/pmc_dh_POCHistoryHelper.getAccountName';
export default class pmc_dh_POCHistory extends LightningElement {
    @api tableData;
    @api tableColumns;
    @api filterColumnsAPINames=["ShippingCountry", "BillingCountry"];
    @api filterColumnLabels=["Shipping Country", "Billing Country"];
    filterData = [];
    tableDataCopy;
    pillData = [];
connectedCallback() {
