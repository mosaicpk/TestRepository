...
export default class Pmc_dh_searchFiltersDoc extends LightningElement {
  @api
  resetInputs() {
  ...
  connectedCallback() {
    ...
    console.log('Custom Parameter Received:', this.variation);
  }
  ...
  // Getter to check if variation is 'document'
  get isDocumentVariation() {
      return this.variation === 'document';
  }
